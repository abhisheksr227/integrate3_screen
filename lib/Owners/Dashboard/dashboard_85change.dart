      ...
      child: Scaffold(
        drawer: NavigationDrawer(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(Icons.account_balance_outlined,color: Colors.blue,size: 20,),
            ...
            ListTile(
              leading:
              Icon(Icons.shopping_bag_sharp,color: Colors.blue,size: 20,),
            ...
            ListTile(
              leading: Icon(Icons.shopping_bag_outlined,color: Colors.blue,size: 20,),
            ...
            ListTile(
              leading: Icon(Icons.report_problem,color: Colors.blue,size: 20,),
            ...
            ListTile(
              leading: Icon(Icons.payments,color: Colors.blue,size: 20,),
            ...
            ListTile(
              leading: Icon(Icons.filter_list_outlined,color: Colors.blue,size: 20,),
            ...
            ListTile(
              leading: Icon(Icons.pie_chart,color: Colors.blue,size: 20,),
            ...
            ListTile(
              leading: Icon(Icons.details,color: Colors.blue,size: 20,),
            ...
            ListTile(
              leading: Icon(Icons.pending_actions,color: Colors.blue,size: 20,),
          ...
          appBar: AppBar(
            ...
            title: Center(child: Text("OWNERS DASHBOARD",style: TextStyle(color: Colors.blue,fontSize: 18,fontWeight: FontWeight.w500))),
            actions: [
              Padding(
